...
import org.dataone.cn.rest.filter.CNServiceDisableFilter;
...
public class TestCNServiceDisableFilter {
    ...
    public void testInit() {
        ...
        CNServiceDisableFilter filter = new CNServiceDisableFilter();
        try {
            filter.init(fc);
