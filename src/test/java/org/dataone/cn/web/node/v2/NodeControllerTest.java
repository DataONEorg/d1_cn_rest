...
package org.dataone.cn.web.node.v2;
...
public class NodeControllerTest {
    ...
    /** the servlet */
    public static Log log = LogFactory.getLog(NodeControllerTest.class);
    ...
    @Autowired
    @Qualifier("sysMetaResource")
    private ClassPathResource sysMetaResource;


    @Autowired
    @Qualifier("invalidSysMetaResource")
