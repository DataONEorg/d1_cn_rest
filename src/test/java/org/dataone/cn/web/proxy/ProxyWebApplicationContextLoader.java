 ...
 */
package org.dataone.cn.web.proxy;
 ...
 * @author rwaltz
 */
public class ProxyWebApplicationContextLoader extends AbstractContextLoader {
    ...
    String basePath = "src/main/webapp";
        try {
         //    File path = ResourceUtils.getFile("target/test-classes");
            File path = ResourceUtils.getFile("src/main/webapp");
