 ...
 * @author waltz
 */
@Service("dataoneX509CertificateGenerator")
public class DataoneX509CertificateGenerator extends AbstractX509CertificateGenerator {

    public DataoneX509CertificateGenerator() {
        super();
    }
    ...
    protected X500NameBuilder getMockCANameBuilder() {
        ...
        nameBuilder.addRDN(RFC4519Style.cn, "Mock DataONE Root CA");
