...
/**
 * Ripped off and slightly modified version of MockHttpServletResponse from wicket- http://wicket.apache.org/
 *
 * @author waltz
 */

/*
 * $Id: MockHttpServletResponse.java 459336 2006-02-15 13:06:22Z jdonnerstag $
 * $Revision: 459336 $
 * $Date: 2006-02-15 14:06:22 +0100 (Wed, 15 Feb 2006) $
 *
 * ==============================================================================
...
public class ProxyHttpServletResponse implements HttpServletResponse {
     ...
     */
    public ProxyHttpServletResponse() {
        this.initialize();
    }
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        if (mode == MODE_TEXT) {
            throw new IllegalArgumentException(
                    "Can't write binary after already selecting text");
        }
        mode = MODE_BINARY;
    ...
    public PrintWriter getWriter() throws IOException {
        if (mode == MODE_BINARY) {
            throw new IllegalArgumentException(
                    "Can't write text after already selecting binary");
        }
        mode = MODE_TEXT;
        return printWriter;
    }
     ...
     */
    @Override
    public void sendError(final int code, final String msg)
            throws IOException {
        this.code = code;
        errorMessage = msg;
    }
